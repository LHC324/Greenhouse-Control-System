...
#define mdRTU_ReadCoils(obj, addr, len, pbits) (obj->registerPool->mdReadCoils(obj->registerPool, addr, len, (mdBit *)&pbits))
...
#define mdRTU_ReadInputCoils(obj, addr, len, pbits) (obj->registerPool->mdReadInputCoils(obj->registerPool, addr, len, (mdBit *)&pbits))
