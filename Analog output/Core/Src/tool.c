...
void IRQ_Handle(IRQ_Type irq)
{
    ...
    GPIO_PinState pin_state = (irq == DisEnable) ? GPIO_PIN_SET : GPIO_PIN_RESET;
    HAL_GPIO_WritePin(M_IRQ_GPIO_Port, M_IRQ_Pin, pin_state);
}
