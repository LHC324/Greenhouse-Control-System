...
/**
 * @brief	模拟量输出
 * @details	STM32F030F4共在io口扩展了8路模拟输出
 * @param	None
 * @retval	None
 */
...
{
    Dac_HandleTypeDef dac_object[EXTERN_ANALOGOUT_MAX] = {
        {.Channel = DAC_OUT1, .Mcpxx_Id = Input_A, .CS.pGPIOx = CS0_GPIO_Port, .CS.Gpio_Pin = CS0_Pin, .CS.PinState = GPIO_PIN_SET},
        {.Channel = DAC_OUT2, .Mcpxx_Id = Input_B, .CS.pGPIOx = CS0_GPIO_Port, .CS.Gpio_Pin = CS0_Pin, .CS.PinState = GPIO_PIN_SET},
        {.Channel = DAC_OUT3, .Mcpxx_Id = Input_A, .CS.pGPIOx = CS2_GPIO_Port, .CS.Gpio_Pin = CS2_Pin, .CS.PinState = GPIO_PIN_SET},
        {.Channel = DAC_OUT4, .Mcpxx_Id = Input_B, .CS.pGPIOx = CS2_GPIO_Port, .CS.Gpio_Pin = CS2_Pin, .CS.PinState = GPIO_PIN_SET},
        {.Channel = DAC_OUT5, .Mcpxx_Id = Input_A, .CS.pGPIOx = CS1_GPIO_Port, .CS.Gpio_Pin = CS1_Pin, .CS.PinState = GPIO_PIN_SET},
        {.Channel = DAC_OUT6, .Mcpxx_Id = Input_B, .CS.pGPIOx = CS1_GPIO_Port, .CS.Gpio_Pin = CS1_Pin, .CS.PinState = GPIO_PIN_SET},
        {.Channel = DAC_OUT7, .Mcpxx_Id = Input_A, .CS.pGPIOx = CS3_GPIO_Port, .CS.Gpio_Pin = CS3_Pin, .CS.PinState = GPIO_PIN_SET},
        {.Channel = DAC_OUT8, .Mcpxx_Id = Input_B, .CS.pGPIOx = CS3_GPIO_Port, .CS.Gpio_Pin = CS3_Pin, .CS.PinState = GPIO_PIN_SET},
    };
