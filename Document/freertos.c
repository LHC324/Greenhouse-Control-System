...
#define D1
      {
        ...
        Close_Qx(3U);
#if defined(USING_DEBUG_APPLICATION)
        shellPrint(Shell_Object, "D1: close Q3.\r\n");
#endif
      }
#define A1
      {
        ...
        if (ps->User.Ptank >= ps->Param.PSspf_start ||
            (ps->User.Pvap_outlet <= ps->Param.PSvap_outlet_stop))
        { /*open counter*/
          // Set_SoftTimer_Flag(&timer[0U], true);
          /*openQ0、openQ1、Q2*/
          Close_Qx(0U), Open_Qx(1U);
          (rbit & 0x03) ? Open_Qx(5U), Close_Qx(6U) : (rbit & 0x04) ? Open_Qx(7U), Close_Qx(8U) : 0;
          /*set flag*/
          mutex_flag = true;
          /*Clear counter*/
          Clear_Counter(&timer[1U]);
#if defined(USING_DEBUG_APPLICATION)
          shellPrint(Shell_Object, "A1: open Q1 or Q5 Q7;close Q0 Q6 or Q8.\r\n");
#endif
          goto __no_action;
        }
        else
...
#if defined(USING_DEBUG_APPLICATION)
            shellPrint(Shell_Object, "A1: close Q1 Q3.\r\n");
#endif
          }
          else
          {
            ...
            else
            {
              ...
              (rbit & 0x03) ? Open_Qx(5U), Close_Qx(6U) : (rbit & 0x04) ? Open_Qx(7U), Close_Qx(8U) : 0;
#if defined(USING_DEBUG_APPLICATION)
              shellPrint(Shell_Object, "A1: open Q5 or Q7 Close Q6 or Q8.\r\n");
#endif
            }
          }
        }
...
#define B1C1
      {
        if (ps->User.Pvap_outlet >= ps->Param.PSvap_outlet_Start)
        {
          ...
          {
            /*open outlet valve*/
            (rbit & 0x03) ? Open_Qx(6U), Close_Qx(7U) : (rbit & 0x04) ? Open_Qx(8U), Close_Qx(9U) : 0;
#if defined(USING_DEBUG_APPLICATION)
            shellPrint(Shell_Object, "B1C1: open Q5 or Q7 Close Q6 or Q8.\r\n");
#endif
          }
          /*open V1 、close V2*/
          Open_Qx(0U), Close_Qx(1U);
#if defined(USING_DEBUG_APPLICATION)
          shellPrint(Shell_Object, "B1C1: open Q0 close Q1\r\n");
#endif
        }
        ...
        //           // Set_SoftTimer_Flag(&timer[1U], true);
        //           /*close V3*/
        //           (rbit & 0x03) ? Close_Qx(5U), Open_Qx(6U) : (rbit & 0x04) ? Close_Qx(7U), Open_Qx(8U) : 0;
        //           Close_Qx(0U), Open_Qx(1U);
        // #if defined(USING_DEBUG_APPLICATION)
        //           shellPrint(Shell_Object, "B1C1: open  Q1  Q5 or Q7;close Q0 Q6 or Q8.\r\n");
        // #endif
        //         }
      }
    }
...
#define A2
      {
            ...
            (ps->User.Ptank < ps->Param.Ptank_difference))
        {
          ...
          Open_Qx(1U);
#if defined(USING_DEBUG_APPLICATION)
          shellPrint(Shell_Object, "A2: open Q1.\r\n");
#endif
        }
        else
        {
          ...
          Close_Qx(1U);
#if defined(USING_DEBUG_APPLICATION)
          shellPrint(Shell_Object, "A2: Close Q1.\r\n");
#endif
        }
      }
#define B2
      {
        if (ps->User.Pvap_outlet >= ps->Param.PPvap_outlet_Start)
        {
          ...
          (rbit & 0x03) ? Open_Qx(5U), Close_Qx(6U) : (rbit & 0x04) ? Open_Qx(7U), Close_Qx(8U) : 0;
          Open_Qx(4U), Close_Qx(1U);
#if defined(USING_DEBUG_APPLICATION)
          shellPrint(Shell_Object, "B2: open Q4 Q5 or Q7;close Q1 Q6 or Q8.\r\n");
#endif
        }
        else if (ps->User.Pvap_outlet <= ps->Param.PPvap_outlet_stop)
        {
          ...
          Close_Qx(4U);
#if defined(USING_DEBUG_APPLICATION)
          shellPrint(Shell_Object, "B2: open Q5 or Q7 close Q4 Q6 or Q8.\r\n");
#endif
        }
      }
#define C2
      {
        if (ps->User.Ptank >= ps->Param.PPspf_start)
        {
          ...
          Open_Qx(3U);
#if defined(USING_DEBUG_APPLICATION)
          shellPrint(Shell_Object, "C2: open Q3.\r\n");
#endif
        }
        else if (ps->User.Ptank <= ps->Param.PPspf_stop)
        {
          ...
          Close_Qx(3U);
#if defined(USING_DEBUG_APPLICATION)
          shellPrint(Shell_Object, "C2: close Q3.\r\n");
#endif
        }
      }
#define D2
      {
        ...
        Close_Qx(0U);
#if defined(USING_DEBUG_APPLICATION)
        shellPrint(Shell_Object, "D2: close Q0.\r\n");
#endif
      }
    }
  __no_action:
